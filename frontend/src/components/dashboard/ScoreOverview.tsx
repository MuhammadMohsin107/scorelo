...
import type { KeyMetric, OverallScore, ScoreTrendPoint } from '../../data/dashboard/dashboard.mock';
...
function ScoreRing({ score, hex }: { score: number; hex: string }) {
  ...
  return (
    <div className="relative h-[152px] w-[152px] flex-shrink-0" role="img" aria-label={`Overall score ${score} out of 100`}>
      ...
      <div className="relative p-6 md:p-7">
        <div className="flex flex-col gap-7 lg:flex-row lg:items-start">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-5 sm:flex-row sm:items-center sm:gap-6">
            <ScoreRing score={data.score} hex={tone.hex} />
            <div className="min-w-0">
              ...
              <p className="mt-3 text-xs text-surface-500">Scored across SEO, Content, Speed, CRO and AI Discovery.</p>
            </div>
          </div>
