 ...
 */
const card = 'rounded-lg border border-surface-200/80 bg-surface-0';
  ...
  return (
    <div className="page-shell section-stack" aria-busy="true" aria-label="Loading dashboard">
      ...
      <div className="grid grid-cols-12 gap-3">
        {/* Hero */}
        <div className={`${card} col-span-12 p-3.5 md:p-7 xl:col-span-8`}>
          <div className="flex flex-col gap-3.5 lg:flex-row">
            ...
            <div className="space-y-2 lg:w-[300px] lg:border-l lg:border-surface-100 lg:pl-7">
          ...
          <div className="mt-2 grid grid-cols-1 gap-2.5 border-t border-surface-100 pt-2.5 sm:grid-cols-3">
        ...
        <div className={`${card} col-span-12 flex flex-col xl:col-span-4`}>
          <div className="flex items-start justify-between border-b border-surface-100 px-3.5 py-2.5">
            <div className="space-y-2">
          ...
          <div className="border-t border-surface-100 px-3.5 py-2">
